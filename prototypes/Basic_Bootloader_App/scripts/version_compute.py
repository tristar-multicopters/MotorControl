...
bash_cmd ="python ./imgtool.py sign -v "+version+ "+" + git_revision +" --header-size 0x400 --align 8 --max-align 8 --slot-size 0x10000 --max-sectors 2 --pad --pad-header ../Objects/Basic_Bootloader_App.hex ../output/Basic_Bootloader_App_Signed.hex"
print(bash_cmd)

...
#define THROTTLE_DIVISOR_THROTTLE2TORQUE       562        /* Divisor for throttle to torque linear transformation  */
...
#define POWERTRAIN_PAS_MAX_TORQUE                          500                 /* Maximum motor torque to apply using pedal assist  */

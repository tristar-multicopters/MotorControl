/**
  * @file    pmsm_motor_parameters_nidec_mid_drive.h
  * @brief   This file contains the parameters needed in order to configure the motor of nidec mid-drive motor.
  *
*/

/* Define to prevent recursive inclusion --- 
----------------------------------*/
#ifndef __PMSM_MOTOR_PARAMETERS_NIDEC_MID_DRIVE_H
#define __PMSM_MOTOR_PARAMETERS_NIDEC_MID_DRIVE_H
...
#define LS                     0.000235 /* Stator inductance, H
...
#define MOTOR_MAGNET_FLUX       0.0160 /* Refers to the Flux of Permanent magnets used in the motor, derived by performing motor tests */

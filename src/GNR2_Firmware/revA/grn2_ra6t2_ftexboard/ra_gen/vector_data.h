/* generated vector header file - do not edit */
        ...
        #define VECTOR_NUMBER_AGT1_INT ((IRQn_Type) 13) /* AGT1 INT (AGT interrupt) */
        #define AGT1_INT_IRQn          ((IRQn_Type) 13) /* AGT1 INT (AGT interrupt) */
        ...
        #define VECTOR_NUMBER_GPT2_CAPTURE_COMPARE_A ((IRQn_Type) 16) /* GPT2 CAPTURE COMPARE A (Compare match A) */
        #define GPT2_CAPTURE_COMPARE_A_IRQn          ((IRQn_Type) 16) /* GPT2 CAPTURE COMPARE A (Compare match A) */

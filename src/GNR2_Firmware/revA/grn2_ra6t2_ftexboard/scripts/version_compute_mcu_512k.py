...
bash_cmd ="python ./imgtool.py sign -v "+version+ "+" + dfu_pack +" --header-size 0x400 --align 8 --max-align 8 --slot-size 0x70000 --max-sectors 2 --pad --pad-header ../Objects/gnr2_ra6t2_mcu_512k.hex ../output/gnr2_ra6t2_Signed_mcu_512k.hex"
print(bash_cmd)

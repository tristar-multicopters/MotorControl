...
const int32_t IqKiVsSpeedTable[CURRENT_PID_VS_SPEED_LUT_SIZE] = {
    ...
    19,   /* old PI = 50 parameter tunning for Vibration */ 
    190,   /* old PI = 50 parameter tunning for Vibration */
...
const int32_t IdKiVsSpeedTable[CURRENT_PID_VS_SPEED_LUT_SIZE] = {
    16,	 /* old PI = 50 parameter tunning for Vibration */
    160,	 /* old PI = 50 parameter tunning for Vibration */
};

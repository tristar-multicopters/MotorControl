...
PAS_Handle_t PedalAssistHandle = 
{
    ...
    .sParameters.PASCCadenceSpeed[0] = PAS_C_LEVEL_SPEED_0,
    .sParameters.PASCCadenceSpeed[1] = PAS_C_LEVEL_SPEED_1,
    .sParameters.PASCCadenceSpeed[2] = PAS_C_LEVEL_SPEED_2,
    .sParameters.PASCCadenceSpeed[3] = PAS_C_LEVEL_SPEED_3,
    .sParameters.PASCCadenceSpeed[4] = PAS_C_LEVEL_SPEED_4,
    .sParameters.PASCCadenceSpeed[5] = PAS_C_LEVEL_SPEED_5,
    .sParameters.PASCCadenceSpeed[6] = PAS_C_LEVEL_SPEED_6,
    .sParameters.PASCCadenceSpeed[7] = PAS_C_LEVEL_SPEED_7,
    .sParameters.PASCCadenceSpeed[8] = PAS_C_LEVEL_SPEED_8,
    .sParameters.PASCCadenceSpeed[9] = PAS_C_LEVEL_SPEED_9,

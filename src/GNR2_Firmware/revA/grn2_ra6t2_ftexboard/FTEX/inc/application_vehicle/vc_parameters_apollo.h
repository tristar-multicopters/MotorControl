...
#define BATTERY_FULL_VOLT    52   // Represents the voltage of the battery when full
#define BATTERY_EMPTY_VOLT   46   // Represents the voltage of the battery when empty

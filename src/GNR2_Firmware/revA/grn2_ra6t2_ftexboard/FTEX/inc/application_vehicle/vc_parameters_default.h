...
----------------------------------*/
#ifndef __VC_PARAMETERS_DEFAULT_H
...
#define HIGH_SPEED_POWER_LIMITING_RAMP_START              22.0f        // Min speed(km/h) where the dynamic deceleration ramp starts
...
#define HIGH_SPEED_POWER_LIMITING_RAMP_POWER_MAX_SPEED    0.0f        // Power allowed (in % of MAX power) at ramp end max speed(km/h)

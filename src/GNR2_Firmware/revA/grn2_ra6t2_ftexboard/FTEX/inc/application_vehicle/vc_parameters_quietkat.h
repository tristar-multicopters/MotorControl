...
#define PEDALSPEEDSENSOR_MIN_PULSE_RUNNING        8    // Mini Number of pulse, inside a specific time, to the detect PAS on cadence when bike is running

/**
  * @file    vc_parameters_mahle.h
  * @brief   This file contains the parameters needed in order to configure the motor of MAHLE bike.
  *
  */

/* Define to prevent recursive inclusion --- 
----------------------------------*/
#ifndef __VC_PARAMETERS_MAHLE_H
#define __VC_PARAMETERS_MAHLE_H

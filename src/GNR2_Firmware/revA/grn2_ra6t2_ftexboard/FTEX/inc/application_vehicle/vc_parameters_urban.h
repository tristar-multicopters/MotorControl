/**
  * @file    vc_parameters_urban.h
  * @brief   This file contains the parameters needed in order to configure the motor of Urban bike.
  *
*/

/* Define to prevent recursive inclusion --- 
----------------------------------*/
#ifndef __VC_PARAMETERS_URBAN_H
#define __VC_PARAMETERS_URBAN_H

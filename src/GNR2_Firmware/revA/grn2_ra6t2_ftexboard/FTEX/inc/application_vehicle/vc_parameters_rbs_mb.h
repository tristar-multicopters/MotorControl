...
#define THROTTLE_MAX_SAFE_SPEED_RPM            1000   // Max Wheel RPM that is safe when using the motor (aprox 38 km/h)
#define THROTTLE_DEFAULT_MAX_SPEED_RPM         1000   // Default top spee din wheel RPM (aprox 32 km/h)

#ifndef __SUPER73_BATTERY_H
#define __SUPER73_BATTERY_H

//NOTE: These values will need to be adjusted when we get the specs for the super73 battery
...
#define MAX_APPLICATION_CURRENT             35                  // Maximum battery current in amps that drive can accept from the motor

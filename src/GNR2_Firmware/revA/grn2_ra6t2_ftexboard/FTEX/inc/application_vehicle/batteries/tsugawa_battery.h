#ifndef __TSUGAWA_BATTERY_H
#define __TSUGAWA_BATTERY_H
...
#define MAX_APPLICATION_POSITIVE_POWER     1500                 // Maximum power in watts that drive can push to the motor
#define MAX_APPLICATION_NEGATIVE_POWER     1500                 // Maximum power in watts that drive can accept from the motor
#define MAX_APPLICATION_CURRENT            20                   // Maximum battery current in amps that drive can accept from the motor

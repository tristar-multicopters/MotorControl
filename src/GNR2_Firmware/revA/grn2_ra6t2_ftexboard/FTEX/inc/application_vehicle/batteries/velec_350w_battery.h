...
#define POWER_LIMIT_REF                     MAX_APPLICATION_CURRENT // Defines if the code should use MAX_APPLICATION_POSITIVE_POWER or MAX_APPLICATION_CURRENT
...
#define UD_VOLTAGE_THRESHOLD_BATT_V             30                   // Under-voltage threshold to prevent BMS shutdown

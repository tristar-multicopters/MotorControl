#ifndef __SUPER73_BATTERY_EZ_ALC_25_13S2P_H
#define __SUPER73_BATTERY_EZ_ALC_25_13S2P_H

//NOTE: These values will need to be adjusted when we get the specs for the super73 z battery EZ-ALC-25_13S2P

/******************************** BATTERY MONITORING PARAMETERS ******************************/

#define BATTERY_FULL_VOLT_X_100   5400 // For now full voltage was estimated from the value of a fully charged battery
#define BATTERY_EMPTY_VOLT_X_100  3800 // empty voltage was taken from the quietkat battery for now
...
#define MAX_APPLICATION_CURRENT             30                  // Maximum battery current in amps that drive can accept from the motor
...
#define MAX_BMS_CONTINUOUS_CURRENT          28                 // Maximum Power at the end point of foldback in amps

...
#define DEFAULT_WHEEL_DIAMETER_OVERRIDE 20
/***************** THROTTLE SELECTION  ******************************/
...
#define PTS_OFFSET_PTS2TORQUE_STARTUP       45              // Offset for pedal torque sensor to torque linear transformation during the startup in %
#define PTS_OFFSET_STARTUP_SPEED_KMH        2              // Speed under which the Startup pedal torque sensor offset is used in km/h
#define PTS_OFFSET_PTS2TORQUE               0              // Offset for pedal torque sensor to torque linear transformation in %

...
#define SWD_CONTROL_ENABLE            0                   /* Enable controlling motor directly from debugging interface with vehicle control layer, to use this feature make sure GNR_MASTER is 1 */
...
#define HSLOG_PROFILE HSLOG_BUTTON_LOG
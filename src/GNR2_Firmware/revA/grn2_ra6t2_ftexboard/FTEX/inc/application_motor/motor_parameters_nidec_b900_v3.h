...
#define MOTOR_NTC_BETA_COEFFICIENT          3984             //Beta coefficient value as specified in the datasheet
#define MOTOR_NTC_RESISTANCE_COEF           63.4f            //This value is calculated based on this formula: exp(NTCBetaCoef / TEMP_25_CELSIUS_IN_KELVIN) / NTC Rated Resistance.

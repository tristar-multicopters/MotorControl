/**
  * @file    drive_parameters_mahle.h
  * @brief   This file contains the parameters needed for the Motor Control application
  *          in order to configure a motor drive. This file is specific to mahle motor.
*/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __DRIVE_PARAMETERS_MAHLE_H
#define __DRIVE_PARAMETERS_MAHLE_H
...
#define MAX_APPLICATION_CURRENT         10      /* Refers to maximum current in amps that drive can accept from the motor */

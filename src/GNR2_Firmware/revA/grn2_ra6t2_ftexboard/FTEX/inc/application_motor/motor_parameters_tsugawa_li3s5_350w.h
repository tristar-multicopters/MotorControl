...
#define RS_VAL                          0.052f                  // Stator resistance , ohm
...
#define HALL_PHASE_SHIFT                    20                  // Electrical phase shift in degrees between the low to high transition of signal H1 and the zero crossing of the Bemf induced between phase A and B

#define EN_VIBRATION_ERROR                  false               // Enable or disable motor vibration error

/************** Wheel Speed Sensor Parameters  *****************************/

#define MOTOR_WSS_NBR_PER_ROTATION          8                   // Wheel speed sensor cycle number for one wheel rotation

/************** Current and Speed PID Parameters  *****************************/

#define IQ_KP_VS_SPEED_1                    2500
#define IQ_KP_VS_SPEED_2                    2500

#define IQ_KI_VS_SPEED_1                    10
#define IQ_KI_VS_SPEED_2                    10

#define ID_KP_VS_SPEED_1                    2500
#define ID_KP_VS_SPEED_2                    2500

/**
  * @file    pmsm_motor_parameters_urban.h
  * @brief   This file contains the parameters needed in order to configure the motor of Urban motor.
  *
*/

/* Define to prevent recursive inclusion ---
----------------------------------*/
#ifndef __PMSM_MOTOR_PARAMETERS_URBAN_H
#define __PMSM_MOTOR_PARAMETERS_URBAN_H

/**
  * @file    pmsm_motor_parameters_utk_350w.h
  * @brief   This file contains the parameters needed in order to configure the motor of utk.
  *
*/

/* Define to prevent recursive inclusion --- 
----------------------------------*/
#ifndef __PMSM_MOTOR_PARAMETERS_UTK_350W_H
#define __PMSM_MOTOR_PARAMETERS_UTK_350W_H

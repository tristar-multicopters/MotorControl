/**
  * @file    motor_parameters_bafang_g040_500w.h
  * @brief   This file contains the parameters needed for the Motor Control application
  *          in order to configure a motor drive. This file is specific to the Bafang G040 500W motor.
...
#ifndef __MOTOR_PARAMETERS_BAFANG_G040_500W_H
#define __MOTOR_PARAMETERS_BAFANG_G040_500W_H
...
#define WHEEL_SPEED_SENSOR_NBR_PER_ROTATION     9               // Wheel speed sensor cycle number for one wheel rotation

/************** Current and Speed PID Parameters  *****************************/

#define IQ_KP_VS_SPEED_1                    132
#define IQ_KP_VS_SPEED_2                    132

#define IQ_KI_VS_SPEED_1                    20
#define IQ_KI_VS_SPEED_2                    20

#define ID_KP_VS_SPEED_1                    124
#define ID_KP_VS_SPEED_2                    124

#define ID_KI_VS_SPEED_1                    20
#define ID_KI_VS_SPEED_2                    20

                                                            
#endif /* __MOTOR_PARAMETERS_BAFANG_G040_500W_H */

...
#define MAX_APPLICATION_SPEED_RPM       1000 /*!< Max speed for the current application in mechanical rpm */
...
#define MAX_APPLICATION_POSITIVE_POWER  2500    /* Refers to maximum power in watts that drive can push to the motor */
#define MAX_APPLICATION_NEGATIVE_POWER  2500    /* Refers to maximum power in watts that drive can accept from the motor */
#define MAX_APPLICATION_CURRENT         50      /* Refers to maximum current in amps that drive can accept from the motor */
...
#define FOLDBACK_SPEED_INTERVAL         400                         /* Speed interval (#SPEED_UNIT) of the decreasing torque ramp to limit speed */
...
#define DEFAULT_TORQUE_SLOPE_UP        80000        /* Slope in cNm per second */
#define DEFAULT_TORQUE_SLOPE_DOWN      80000        /* Slope in cNm per second */

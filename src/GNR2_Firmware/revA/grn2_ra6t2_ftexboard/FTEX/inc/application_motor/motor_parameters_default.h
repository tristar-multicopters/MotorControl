...
#ifndef __MOTOR_PARAMETERS_DEFAULT_H
#define __MOTOR_PARAMETERS_DEFAULT_H
...
#define MOTOR_WSS_NBR_PER_ROTATION          10                   // Wheel speed sensor cycle number for one wheel rotation
...
#endif /* __MOTOR_PARAMETERS_DEFAULT_H */

...
#define PHASE_WIRE_DISCONNECT_WAIT_MCCYCLE  1000        // The time to wait and check before rasing error
...
#define SPEED_TORQUE_SWITCHING_RANGE_KMPH   6       // speed threshold value for switching between Speed mode and Torque mode
#define SPEED_TORQUE_SWITCHING_RANGE_RPM    SPEED_TORQUE_SWITCHING_RANGE_KMPH * MOTOR_GEAR_RATIO    

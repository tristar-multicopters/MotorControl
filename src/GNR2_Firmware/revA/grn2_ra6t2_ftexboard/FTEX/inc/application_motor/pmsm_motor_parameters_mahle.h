/**
  * @file    pmsm_motor_parameters_mahle.h
  * @brief   This file contains the parameters needed in order to configure the motor of mahle motor.
  *
*/

/* Define to prevent recursive inclusion --- 
----------------------------------*/
#ifndef __PMSM_MOTOR_PARAMETERS_MAHLE_H
#define __PMSM_MOTOR_PARAMETERS_MAHLE_H

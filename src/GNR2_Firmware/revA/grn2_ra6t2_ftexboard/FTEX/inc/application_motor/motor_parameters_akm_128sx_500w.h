...
#define RS_VAL                              0.1f             // Stator resistance in ohms
#define LS                                  0.000235f        // Stator inductance in H (For I-PMSM it is equal to Lq)
...
#define MOTOR_NTC_RATED_RESISTANCE          10000            //NTC resistance at 25 degree celsius in ohm
...
#define MOTOR_WSS_NBR_PER_ROTATION          1                // Wheel speed sensor cycle number for one wheel rotation
#define MOTOR_WSS_TIME_ON_ONE_MAGNET_PERCENT    (float)1.12  // Percentage of time that the wheel speed sensor spends on each magnet

/**
  * @file    pmsm_motor_parameters_quietkat.h
  * @brief   This file contains the parameters needed in order to configure the motor of quietkat motor.
  *
*/

/* Define to prevent recursive inclusion ---
----------------------------------*/
#ifndef __PMSM_MOTOR_PARAMETERS_QUIETKAT_H
#define __PMSM_MOTOR_PARAMETERS_QUIETKAT_H

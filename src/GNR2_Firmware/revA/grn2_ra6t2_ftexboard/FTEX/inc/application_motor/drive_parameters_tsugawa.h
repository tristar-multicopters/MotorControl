...
#define No_Load_PID_KIq_Gain    800  /* this is the Kiq  when the torque set is very low
                                                             main sensor goes in fault */ 
/****** Hall sensors ************/
...
#define OV_TEMP_INVERTER_THRESHOLD_C      70 /*!< Heatsink overtemperature threshold before thermal shutdown. Celsius degrees */
#define OV_TEMP_INVERTER_HYSTERESIS_C     15 /*!< Heatsink overtemperature hysteresis after a thermal shutdown occured. Celsius degrees */
...
#define PID_SPEEDLIMIT_KI_DEFAULT     PID_SPEED_KI_DEFAULT           /* Default gain speed limit control loop */
...
#define FOLDBACK_SPEED_INTERVAL         500 //750 Removed to let VC control top speed /* Speed interval (#SPEED_UNIT) of the decreasing torque ramp to limit speed */

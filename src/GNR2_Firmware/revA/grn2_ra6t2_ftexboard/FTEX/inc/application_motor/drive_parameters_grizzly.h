...
#define OV_TEMPERATURE_THRESHOLD_C      72 /*!< Heatsink overtemperature threshold before thermal shutdown. Celsius degrees */
...
#define MAX_APPLICATION_NEGATIVE_POWER  1500    /* Refers to maximum power that drive can accept from the motor */
...
#define FOLDBACK_HS_TEMP_INTERVAL       36                         /* Temperature interval (degree C) of the decreasing torque ramp to limit heatsink temperature */

/**
  * @file    pmsm_motor_parameters_a2_500w.h
  * @brief   This file contains the parameters needed in order to configure the motor of velec a2 500w motor.
  *
*/

/* Define to prevent recursive inclusion --- 
----------------------------------*/
#ifndef __PMSM_MOTOR_PARAMETERS_A2_500W_H
#define __PMSM_MOTOR_PARAMETERS_A2_500W_H

/**
  * @file    vc_parameters_wheel.h
  * @brief   This file contains the parameters needed in order to configure the motor of wheel bike.
  *
*/

/* Define to prevent recursive inclusion --- 
----------------------------------*/
#ifndef __VC_PARAMETERS_WHEEL_H
#define __VC_PARAMETERS_WHEEL_H
...
#define POWERTRAIN_PAS_MAX_TORQUE_RATIO                   99                /* Maximum PAS Torque feed ration in 100% */
#define POWERTRAIN_PAS_MAX_SPEED_RATIO                    99               /* Maximum PAS Speed feed ration in 100% */

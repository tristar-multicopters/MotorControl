/**
  * @file    vc_parameters_nidec_mid_drive.h
  * @brief   This file contains the parameters needed in order to configure the motor of nidec_mid_drive bike.
  *
*/

/* Define to prevent recursive inclusion --- 
----------------------------------*/
#ifndef __VC_PARAMETERS_NIDEC_MID_DRIVE_H
#define __VC_PARAMETERS_NIDEC_MID_DRIVE_H

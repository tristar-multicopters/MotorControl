/**
  * @file    drive_parameters_nidec_mid_drive.h
  * @brief   This file contains the parameters needed for the Motor Control application
  *          in order to configure a motor drive. This file is specific to nidec mid-drive motor.
*/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __DRIVE_PARAMETERS_NIDEC_MID_DRIVE_H
#define __DRIVE_PARAMETERS_NIDEC_MID_DRIVE_H
...
#define MAX_APPLICATION_SPEED_RPM       3500   /*!< Max speed for the current application in mechanical rpm */
...
#define MAX_APPLICATION_POSITIVE_POWER  350         /* Refers to maximum power that drive can push to the motor */
#define MAX_APPLICATION_NEGATIVE_POWER  350         /* Refers to maximum power that drive can accept from the motor */
...
#endif /*__DRIVE_PARAMETERS_NIDEC_MID_DRIVE_H*/

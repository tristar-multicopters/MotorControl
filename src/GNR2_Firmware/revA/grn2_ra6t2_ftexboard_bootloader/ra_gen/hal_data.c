...
sci_b_uart_instance_ctrl_t     g_uart1_ctrl;
            ...
            {
                /* Baud rate calculated with 3.340% error. */ .baudrate_bits_b.abcse = 0, .baudrate_bits_b.abcs = 0, .baudrate_bits_b.bgdm = 1, .baudrate_bits_b.cks = 0, .baudrate_bits_b.brr = 20, .baudrate_bits_b.mddr = (uint8_t) 256, .baudrate_bits_b.brme = false
            };
...
const timer_cfg_t g_timer0_cfg =
{
    ...
    /* Actual period: 3 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0xaba9500, .duty_cycle_counts = 0x55d4a80, .source_div = (timer_source_div_t)0,
    .channel             = 0,
    .p_callback          = NULL,

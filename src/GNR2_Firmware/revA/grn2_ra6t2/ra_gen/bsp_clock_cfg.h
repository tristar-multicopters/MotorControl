...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL_10_0 /* PLL2 Mul x10.0 */
...
#define BSP_CFG_SCISPICLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL) /* SCISPICLK Src: PLL */
#define BSP_CFG_CANFDCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL) /* CANFDCLK Src: PLL */
#define BSP_CFG_GPTCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL) /* GPTCLK Src: PLL */
#define BSP_CFG_IICCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL) /* IICCLK Src: PLL */
...
#define BSP_CFG_IICCLK_DIV (BSP_CLOCKS_IIC_CLOCK_DIV_2) /* IICCLK Div /2 */

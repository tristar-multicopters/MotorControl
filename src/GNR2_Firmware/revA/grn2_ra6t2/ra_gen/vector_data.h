/* generated vector header file - do not edit */
        ...
        #define VECTOR_NUMBER_ICU_IRQ10 ((IRQn_Type) 3) /* ICU IRQ10 (External pin interrupt 10) */
        #define ICU_IRQ10_IRQn          ((IRQn_Type) 3) /* ICU IRQ10 (External pin interrupt 10) */
        ...
        #define VECTOR_NUMBER_GPT0_CAPTURE_COMPARE_A ((IRQn_Type) 6) /* GPT0 CAPTURE COMPARE A (Compare match A) */
        #define GPT0_CAPTURE_COMPARE_A_IRQn          ((IRQn_Type) 6) /* GPT0 CAPTURE COMPARE A (Compare match A) */
        #ifdef __cplusplus
        }
        #endif
        #endif /* VECTOR_DATA_H */
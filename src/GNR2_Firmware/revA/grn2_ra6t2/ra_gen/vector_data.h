/* generated vector header file - do not edit */
        ...
        #define VECTOR_NUMBER_CAN0_CHERR ((IRQn_Type) 15) /* CAN0 CHERR (Channel error) */
        #define CAN0_CHERR_IRQn          ((IRQn_Type) 15) /* CAN0 CHERR (Channel error) */
        #define VECTOR_NUMBER_CAN0_TX ((IRQn_Type) 16) /* CAN0 TX (Transmit interrupt) */
        #define CAN0_TX_IRQn          ((IRQn_Type) 16) /* CAN0 TX (Transmit interrupt) */
        ...
        #define VECTOR_NUMBER_CAN_RXF ((IRQn_Type) 18) /* CAN RXF (Global recieve FIFO interrupt) */
        #define CAN_RXF_IRQn          ((IRQn_Type) 18) /* CAN RXF (Global recieve FIFO interrupt) */
        #define VECTOR_NUMBER_AGT1_INT ((IRQn_Type) 19) /* AGT1 INT (AGT interrupt) */
        #define AGT1_INT_IRQn          ((IRQn_Type) 19) /* AGT1 INT (AGT interrupt) */
        #ifdef __cplusplus
        }
        #endif
        #endif /* VECTOR_DATA_H */
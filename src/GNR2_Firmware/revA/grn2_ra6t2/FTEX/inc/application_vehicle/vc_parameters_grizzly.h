...
#define THROTTLE_LOWPASS_FILTER_BW2           2        /* Low pass filter bandwidth when going down,
                                                          higher number means slower response */
#define THROTTLE_OFFSET_ADC2THROTTLE          13000 //10000    /* Offset for ADC to throttle linear transformation  */
...
#define THROTTLE_SLOPE_THROTTLE2TORQUE        -2 //-14        /* Slope for throttle to torque linear transformation  */
#define THROTTLE_DIVISOR_THROTTLE2TORQUE      48        /* Divisor for throttle to torque linear transformation  */
...
#define POWERTRAIN_PAS_MAX_TORQUE                         -10000            /* Maximum motor torque to apply using pedal assist  */
...
#define POWERTRAIN_HEATSINK_TEMP_FOLDBACK_MAX_TORQUE      17000                /* Max torque of heatsink temperature torque foldback */

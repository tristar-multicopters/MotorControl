...
{ 
	...
	bool bUseWheelSpeedSensor;				/* Set true if wheel speed sensor is used */
...
typedef struct
{
	...
	PedalSpeedSens_Handle_t * pPAS;			/* Pointer to PAS handle */
    WheelSpeedSens_Handle_t * pWSS;     /* Pointer to Wheel Speed Sensor handle */

...
/**
  ...
  @param  PF_Handle_AGT_t
  @return bIsError in boolean
*/
bool PulseFrequency_Initialisation_AGT(PF_Handle_AGT_t * pHandle)
{
    bool bIsError = false;
    bIsError |= R_GPT_Open(pHandle->PF_Param_AGT.PF_AGT_Timer->p_ctrl, pHandle->PF_Param_AGT.PF_AGT_Timer->p_cfg);
    return bIsError;
}
...
/**
  ...
  @return bIsError in boolean
*/
bool PulseFrequency_Deinitialisation_AGT(PF_Handle_AGT_t * pHandle)
{
    bool bIsError = false;
    bIsError |= R_GPT_Stop(pHandle->PF_Param_AGT.PF_AGT_Timer->p_ctrl);
    return bIsError;
}
...
/**
  ...
  @return bIsError in boolean
*/
bool PulseFrequency_Enable_AGT(PF_Handle_AGT_t * pHandle)
{
    bool bIsError = false;
    bIsError |= R_GPT_Enable(pHandle->PF_Param_AGT.PF_AGT_Timer->p_ctrl);
    return bIsError;
}
...
/**
  ...
  @return bIsError in boolean
*/
bool PulseFrequency_Disable_AGT(PF_Handle_AGT_t * pHandle)
{
    bool bIsError = false;
    bIsError |= R_GPT_Disable(pHandle->PF_Param_AGT.PF_AGT_Timer->p_ctrl);
    return bIsError;
}
...
/**
  ...
  @return bIsError in boolean
*/
bool PulseFrequency_Reset_AGT(PF_Handle_AGT_t * pHandle)
{
    bool bIsError = false;
    bIsError |= R_GPT_Reset(pHandle->PF_Param_AGT.PF_AGT_Timer->p_ctrl);
    return bIsError;
}

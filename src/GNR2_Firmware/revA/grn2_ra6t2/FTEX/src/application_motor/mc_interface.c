    ...
    if ( pHandle->CommandState == MCI_COMMAND_NOT_ALREADY_EXECUTED )
    {
      ...
      switch ( pHandle->LastCommand )
      {
        case MCI_EXECSPEEDRAMP:
        {
          ...
          commandHasBeenExecuted = SpdTorqCtrl_ExecRamp( pHandle->pSpeedTorqCtrl, pHandle->hFinalSpeed, pHandle->hDurationms );
        }
        break;
        case MCI_EXECTORQUERAMP:
        {
          ...
          commandHasBeenExecuted = SpdTorqCtrl_ExecRamp( pHandle->pSpeedTorqCtrl, pHandle->hFinalTorque, pHandle->hDurationms );
        }
        break;
...
bool MCInterface_RampCompleted( MotorControlInterfaceHandle_t * pHandle )
{
  ...
  {
    retVal = SpdTorqCtrl_RampCompleted( pHandle->pSpeedTorqCtrl );
  }

/**
  ******************************************************************************
  * @file    external_memory_driver.h
  * @brief   This file is the MX25 serial flash header
  ******************************************************************************
*/

#ifndef __EXTERNAL_MEMORY_DRIVER_H
#define __EXTERNAL_MEMORY_DRIVER_H
...
/* MX25L3233F Component Error codes *********************************************/
typedef enum
{
  MX25L3233F_OK                 =  0,
...
/**
  ...
  * @param  MX25L3233F_Info_t
  * @retval SPI memory status
  */
int32_t SF_GetFlashInfo(MX25L3233F_Info_t *pInfo); 
...
#endif /* __EXTERNAL_MEMORY_DRIVER_H */
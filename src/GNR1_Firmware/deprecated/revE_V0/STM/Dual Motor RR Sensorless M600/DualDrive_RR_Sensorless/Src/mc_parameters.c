...
/* Current reading A/D Conversions initialization -----------------------------*/
  .ADCx_1 = ADC3,
  .ADCx_2 = ADC3,
  .ADCConfig1 =   (MC_ADC_CHANNEL_1 << ADC_JSQR_JSQ1_Pos) | (MC_ADC_CHANNEL_12 << ADC_JSQR_JSQ2_Pos) | 1 << ADC_JSQR_JL_Pos | LL_ADC_INJ_TRIG_EXT_RISING | LL_ADC_INJ_TRIG_EXT_TIM8_TRGO,
  .ADCConfig2 =   (MC_ADC_CHANNEL_1 << ADC_JSQR_JSQ1_Pos) | (MC_ADC_CHANNEL_12 << ADC_JSQR_JSQ2_Pos) | 1 << ADC_JSQR_JL_Pos | LL_ADC_INJ_TRIG_EXT_RISING | LL_ADC_INJ_TRIG_EXT_TIM8_TRGO,

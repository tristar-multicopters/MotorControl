...
static void ICS_HFCurrentsPolarization_Alt( PWMC_Handle_t * pHdl,ab_t * Iab );
...
__weak void ICS_CurrentReadingPolarization_Alt( PWMC_Handle_t * pHdl )
{
#if defined (__ICCARM__)
  #pragma cstat_disable = "MISRAC2012-Rule-11.3"
#endif /* __ICCARM__ */
  ...
  /* Offset calibration for all phases */
  /* Change function to be executed in ADCx_ISR */
  pHandle->_Super.pFctGetPhaseCurrents = &ICS_HFCurrentsPolarization_Alt;
  ICS_SwitchOnPWM( &pHandle->_Super );
  ...
  /* Change back function to be executed in ADCx_ISR */
  pHandle->_Super.pFctGetPhaseCurrents = &ICS_GetPhaseCurrents_Alt;
  pHandle->_Super.pFctSetADCSampPointSectX = &ICS_WriteTIMRegisters;
...
__weak void ICS_GetPhaseCurrents_Alt( PWMC_Handle_t * pHdl, ab_t * Iab )
{
#if defined (__ICCARM__)
  #pragma cstat_disable = "MISRAC2012-Rule-11.3"
#endif /* __ICCARM__ */
...
static void ICS_HFCurrentsPolarization_Alt( PWMC_Handle_t * pHdl, ab_t * Iab )
{
  ...
  {
    pHandle-> PhaseAOffset += ADCx_1->JDR1;
    pHandle-> PhaseBOffset += ADCx_2->JDR2;
    pHandle->PolarizationCounter++;
  }

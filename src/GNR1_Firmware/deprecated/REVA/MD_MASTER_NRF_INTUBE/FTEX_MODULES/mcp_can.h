...
#define EXT_ID 0x01
#define STD_ID 0x00
#define BYTE_3_4 0xFF00
#define BYTE_1_2 0xFF
...
#define MCP_20MHz_200kBPS_CFG2 (0xBF)
#define MCP_20MHz_200kBPS_CFG3 (0x07)

#define MCP_20MHz_125kBPS_CFG1 (0x03)
#define MCP_20MHz_125kBPS_CFG2 (0xAC)
#define MCP_20MHz_125kBPS_CFG3 (0x07)

#define MCP_20MHz_100kBPS_CFG1 (0x03)
#define MCP_20MHz_100kBPS_CFG2 (0xBF)
#define MCP_20MHz_100kBPS_CFG3 (0x07)

#define MCP_20MHz_95kBPS_CFG1 (0x04)
#define MCP_20MHz_95kBPS_CFG2 (0xAD)
#define MCP_20MHz_95kBPS_CFG3 (0x07)

#define MCP_20MHz_83k3BPS_CFG1 (0x04)
#define MCP_20MHz_83k3BPS_CFG2 (0xBE)
#define MCP_20MHz_83k3BPS_CFG3 (0x07)

#define MCP_20MHz_80kBPS_CFG1 (0x04)
#define MCP_20MHz_80kBPS_CFG2 (0xBF)
#define MCP_20MHz_80kBPS_CFG3 (0x07)

#define MCP_20MHz_50kBPS_CFG1 (0x07)
#define MCP_20MHz_50kBPS_CFG2 (0xBF)
#define MCP_20MHz_50kBPS_CFG3 (0x07)

#define MCP_20MHz_40kBPS_CFG1 (0x09)
#define MCP_20MHz_40kBPS_CFG2 (0xBF)
#define MCP_20MHz_40kBPS_CFG3 (0x07)

#define MCP_20MHz_33kBPS_CFG1 (0x0F)
#define MCP_20MHz_33kBPS_CFG2 (0xA4)
#define MCP_20MHz_33kBPS_CFG3 (0x07)

#define MCP_20MHz_31k25BPS_CFG1 (0x0F)
#define MCP_20MHz_31k25BPS_CFG2 (0xAC)
#define MCP_20MHz_31k25BPS_CFG3 (0x07)

#define MCP_20MHz_25kBPS_CFG1 (0X0F)
#define MCP_20MHz_25kBPS_CFG2 (0XBF)
#define MCP_20MHz_25kBPS_CFG3 (0X07)

#define MCP_20MHz_20kBPS_CFG1 (0x13)
#define MCP_20MHz_20kBPS_CFG2 (0xBF)
#define MCP_20MHz_20kBPS_CFG3 (0x07)

#define MCP_20MHz_10kBPS_CFG1 (0x27)
#define MCP_20MHz_10kBPS_CFG2 (0xBF)
#define MCP_20MHz_10kBPS_CFG3 (0x07)

//#define MCP_20MHz_5kBPS_CFG1 (0x3F)
//#define MCP_20MHz_5kBPS_CFG2 (0xFF)
//#define MCP_20MHz_5kBPS_CFG3 (0x87)

#define MCP_20MHz_666kBPS_CFG1 (0x00)
#define MCP_20MHz_666kBPS_CFG2 (0x9A)
#define MCP_20MHz_666kBPS_CFG3 (0x06)
...
typedef struct
{
		...
		uint8_t can_ext_flg;                // identifier xxxID, either extended (the 29 LSB) or standard (the 11 LSB)
		uint32_t can_id;                    // can id
		uint8_t can_rtr;                    // rtr 
		uint8_t spi_cs;                 		// SPI chip select
		uint8_t can_mcpMode;                // Current controller mode
		uint8_t canSpeed;
		uint8_t clock;
} mcp_can_t;

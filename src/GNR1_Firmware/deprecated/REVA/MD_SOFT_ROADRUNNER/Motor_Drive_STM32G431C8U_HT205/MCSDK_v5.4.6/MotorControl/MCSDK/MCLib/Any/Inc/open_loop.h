...
typedef struct
{
  ...
  SpeednPosFdbk_Handle_t * pSPF; /**< Allow access on mechanical speed measured. */
...
/**
  ...
  *  @retval none
  */
void OL_Init( OpenLoop_Handle_t * pHandle, SpeednPosFdbk_Handle_t * pSPF );
...
/**
  ...
  * @retval None
  */
void OL_UpdateElSpeed( OpenLoop_Handle_t * pHandle, int16_t hNewElSpeed );

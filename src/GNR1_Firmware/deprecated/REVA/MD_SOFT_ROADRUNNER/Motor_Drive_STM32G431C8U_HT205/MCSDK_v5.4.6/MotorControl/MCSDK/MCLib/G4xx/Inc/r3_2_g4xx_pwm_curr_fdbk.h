...
typedef const struct
{
 ...
 /* PWM generation parameters --------------------------------------------------*/
  ...
  uint8_t  IsHigherFreqTim;       /*!< When bFreqRatio is greather than 1
	...
	TIM_TypeDef * TIM_OCPa;								 /*!< timer used for delaying phase A protection.*/
	TIM_TypeDef * TIM_OCPb;								 /*!< timer used for delaying phase B protection.*/
	TIM_TypeDef * TIM_OCPc;								 /*!< timer used for delaying phase C protection.*/
	
	uint32_t Tdelay_OCP;								 /*!< delay of OCP in ticks.*/

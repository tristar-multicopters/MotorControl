...
#define MC_PROTOCOL_CODE_ENTER_CONFIG     0x13
#define MC_PROTOCOL_CODE_EXIT_CONFIG      0x14
#define MC_PROTOCOL_CODE_GET_CONFIG_REG   0x15
#define MC_PROTOCOL_CODE_SET_CONFIG_REG   0x16
#define MC_PROTOCOL_CODE_CONFIG_OVERWRITE 0x17

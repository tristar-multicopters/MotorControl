...
PID_Handle_t PIDFluxWeakeningHandle_M1 =
{
  ...
  .wLowerIntegralLimit = (int32_t)(ID_DEMAG) * (int32_t)FW_KIDIV,
  .hUpperOutputLimit       = 0,
  .hLowerOutputLimit       = -INT16_MAX,
...
Derate_Handle_t DerateM1 =
{
  .pThermistor1          		= &TempSensorParamsM1,
  .pTemperatureTable        = {70, 80},
  .pTorquePercentageTable 	= {50, 25},
  .hTableSize        				= DERATE_TABLE_SIZE,
};

...
#define RS                     0.5 /* Stator resistance , ohm*/
...
#define NOMINAL_CURRENT         20000
#define MOTOR_MAX_SPEED_RPM     400 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  88 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -7500 /*!< Demagnetization current */
...
/***************** MOTOR ELECTRICAL PARAMETERS  ******************************/
#define POLE_PAIR_NUM2          23 /* Number of motor pole pairs */
#define RS2                     0.5 /* Stator resistance , ohm*/
#define LS2                     0.000200 /* Stator inductance, H
                                                 For I-PMSM it is equal to Lq */
...
#define NOMINAL_CURRENT2         20000
#define MOTOR_MAX_SPEED_RPM2     400 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT2  88 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG2                -7500 /*!< Demagnetization current */

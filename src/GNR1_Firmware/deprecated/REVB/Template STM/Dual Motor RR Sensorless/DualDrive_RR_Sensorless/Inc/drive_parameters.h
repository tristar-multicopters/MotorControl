...
#define OV_VOLTAGE_THRESHOLD_V          65 /*!< Over-voltage
                                                         threshold */
...
#define ON_OVER_VOLTAGE                 TURN_OFF_PWM /*!< TURN_OFF_PWM,
                                                         ...
                                                         TURN_ON_LOW_SIDES */
#endif /* 0 */
#define R_BRAKE_SWITCH_OFF_THRES_V      52
...
/* Phase 3 */
#define PHASE3_DURATION                10 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (0*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           992
/* Phase 4 */
#define PHASE4_DURATION                1490 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (100*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           992
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (100*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           992
...
#define CONSTANT1_Q                    132830
#define CONSTANT1_D                    132830
#define CONSTANT2_QD                   37524
...
#define PHASE3_FINAL_CURRENT2           992
/* Phase 4 */
#define PHASE4_DURATION2                250 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT2         (16*SPEED_UNIT/_RPM) /* rpm */
#define PHASE4_FINAL_CURRENT2           992
/* Phase 5 */
#define PHASE5_DURATION2                1250 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT2         (100*SPEED_UNIT/_RPM) /* rpm */
#define PHASE5_FINAL_CURRENT2           992
...
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM2          50

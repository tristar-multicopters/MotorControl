...
#define CORD_F22                          1024
#define CORD_F1_LOG2                      LOG2(16384)
#define CORD_F2_LOG2                      LOG2(1024)

/* State observer constants */
#define CORD_GAIN12                       -4000
#define CORD_GAIN22                       4000
...
#define SW_DEADTIME_NS2                   400 /*!< Dead-time to be inserted
                                                           by FW, only if low side
                                                           signals are enabled */
/* Torque and flux regulation loops */
...
#define DEFAULT_CONTROL_MODE2           STC_TORQUE_MODE /*!< STC_TORQUE_MODE or
                                                        STC_SPEED_MODE */
#define DEFAULT_TARGET_SPEED_RPM2 			100
...
/* Phase 3 */
#define PHASE3_DURATION2                50000 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT2        0 //(2*SPEED_UNIT/_RPM) /* rpm */
#define PHASE3_FINAL_CURRENT2           500
/* Phase 4 */
#define PHASE4_DURATION2                1900 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT2         (50*SPEED_UNIT/_RPM) /* rpm */
#define PHASE4_FINAL_CURRENT2           500
/* Phase 5 */
#define PHASE5_DURATION2                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT2         (50*SPEED_UNIT/_RPM) /* rpm */
#define PHASE5_FINAL_CURRENT2           500
...
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM2          25

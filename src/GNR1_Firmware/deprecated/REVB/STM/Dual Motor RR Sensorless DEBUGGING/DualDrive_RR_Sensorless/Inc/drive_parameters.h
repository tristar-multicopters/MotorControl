...
#define CORD_GAIN1                       -20000
#define CORD_GAIN2                       1000

#define CORD_MEAS_ERRORS_BEFORE_FAULTS   12  /*!< Number of consecutive errors
...
#define CORD_FIFO_DEPTH_UNIT            64  /*!< Depth of the FIFO used
                                                           to average mechanical speed
                                                           in dpp format */
#define CORD_MAX_ACCEL_DPPP              578  /*!< Maximum instantaneous
...
#define OV_VOLTAGE_THRESHOLD_V          80 /*!< Over-voltage
                                                         threshold */
...
#define ON_OVER_VOLTAGE                 TURN_OFF_PWM /*!< TURN_OFF_PWM,
                                                         ...
                                                         TURN_ON_LOW_SIDES */
#endif /* 0 */
#define R_BRAKE_SWITCH_OFF_THRES_V      72
...
#define PHASE2_FINAL_CURRENT           2500
/* Phase 3 */
#define PHASE3_DURATION                25000 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (200*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           2500
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (200*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           2500
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (200*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           2500

#define ENABLE_SL_ALGO_FROM_PHASE      2
/* Sensor-less rev-up sequence */
#define STARTING_ANGLE_DEG             270  /*!< degrees [0...359] */
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM          10000
...
#define CORD_F2_LOG2                      LOG2(128)

/* State observer constants */
#define CORD_GAIN12                       -24098
#define CORD_GAIN22                       21661
...
#define CORD_FIFO_DEPTH_UNIT2             64  /*!< Depth of the FIFO used
                                                           to average mechanical speed
                                                           in dpp format */
#define CORD_MAX_ACCEL_DPPP2              394  /*!< Maximum instantaneous
                                                              electrical acceleration (dpp
                                                              per control period) */
...
#define OV_VOLTAGE_THRESHOLD_V2          65 /*!< Over-voltage
                                                         threshold */
...
#define R_BRAKE_SWITCH_OFF_THRES_V2      52

#define OV_TEMPERATURE_THRESHOLD_C2      75 /*!< Celsius degrees */
...
/* Phase 2 */
#define PHASE2_DURATION2                250 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT2         (0*SPEED_UNIT/_RPM) /* rpm */
#define PHASE2_FINAL_CURRENT2           2500
/* Phase 3 */
#define PHASE3_DURATION2                25000 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT2         (200*SPEED_UNIT/_RPM) /* rpm */
#define PHASE3_FINAL_CURRENT2           2500
/* Phase 4 */
#define PHASE4_DURATION2                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT2         (200*SPEED_UNIT/_RPM) /* rpm */
#define PHASE4_FINAL_CURRENT2           2500
/* Phase 5 */
#define PHASE5_DURATION2                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT2         (200*SPEED_UNIT/_RPM) /* rpm */
#define PHASE5_FINAL_CURRENT2           2500
...
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM2          1000
#define NB_CONSECUTIVE_TESTS2           5 /* corresponding to
                                                         former NB_CONSECUTIVE_TESTS/
                                                         (TF_REGULATION_RATE/
                                                         MEDIUM_FREQUENCY_TASK_RATE) */

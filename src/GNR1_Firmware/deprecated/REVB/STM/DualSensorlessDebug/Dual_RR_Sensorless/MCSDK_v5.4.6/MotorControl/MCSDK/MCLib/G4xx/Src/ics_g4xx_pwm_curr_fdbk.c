...
__weak void ICS_CurrentReadingPolarizationInverted( PWMC_Handle_t * pHdl )
{
#if defined (__ICCARM__)
  #pragma cstat_disable = "MISRAC2012-Rule-11.3"
#endif /* __ICCARM__ */
  ...
  /* Change back function to be executed in ADCx_ISR */
  pHandle->_Super.pFctGetPhaseCurrents = &ICS_GetPhaseCurrentsInverted;
  pHandle->_Super.pFctSetADCSampPointSectX = &ICS_WriteTIMRegisters;
...
__weak void ICS_GetPhaseCurrentsInverted( PWMC_Handle_t * pHdl, ab_t * Iab )
{
#if defined (__ICCARM__)
  #pragma cstat_disable = "MISRAC2012-Rule-11.3"
#endif /* __ICCARM__ */

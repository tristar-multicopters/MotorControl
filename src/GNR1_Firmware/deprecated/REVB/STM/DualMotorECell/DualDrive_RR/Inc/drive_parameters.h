...
#define MIN_APPLICATION_SPEED_RPM       0 /*!< rpm, mechanical,
                                                           absolute value */
#define MEAS_ERRORS_BEFORE_FAULTS       8 /*!< Number of speed
                                                             measurement errors before
                                                             main sensor goes in fault */
/****** Hall sensors ************/
#define HALL_MEAS_ERRORS_BEFORE_FAULTS  8 /*!< Number of failed
...
#define PID_TORQUE_KP_DEFAULT         25
#define PID_TORQUE_KI_DEFAULT         3
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           25
#define PID_FLUX_KI_DEFAULT           3
...
#define OV_VOLTAGE_THRESHOLD_V          90 /*!< Over-voltage
                                                         threshold */
...
#define MIN_APPLICATION_SPEED_RPM2           0 /*!< rpm, mechanical,
                                                           absolute value */
#define MEAS_ERRORS_BEFORE_FAULTS2       8 /*!< Number of speed
                                                             measurement errors before
                                                             main sensor goes in fault */
/****** Hall sensors ************/
#define HALL_MEAS_ERRORS_BEFORE_FAULTS2  8 /*!< Number of failed
                                                           derived class specific speed
                                                           measurements before main sensor
                                                           goes in fault */
#define HALL_AVERAGING_FIFO_DEPTH2        12 /*!< depth of the FIFO used to
                                                           average mechanical speed in
                                                           0.1Hz resolution */
...
#define REGULATION_EXECUTION_RATE2     1    /*!< FOC execution rate in
                                                           number of PWM cycles */
/* Gains values for torque and flux control loops */
#define PID_TORQUE_KP_DEFAULT2         25
#define PID_TORQUE_KI_DEFAULT2         3
#define PID_TORQUE_KD_DEFAULT2         100
#define PID_FLUX_KP_DEFAULT2           25
#define PID_FLUX_KI_DEFAULT2           3
...
#define OV_VOLTAGE_THRESHOLD_V2          90 /*!< Over-voltage
                                                         threshold */
...
#define R_BRAKE_SWITCH_OFF_THRES_V2      72
...
#define THRESHOLD_MIDSPEED							200 //RPM

#define PID_TORQUE_KP_MIDSPEED					50
#define PID_TORQUE_KI_MIDSPEED					5
#define PID_FLUX_KP_MIDSPEED						50
#define PID_FLUX_KI_MIDSPEED						5

#define THRESHOLD_HIGHSPEED							400 //RPM

#define PID_TORQUE_KP_HIGHSPEED					100
#define PID_TORQUE_KI_HIGHSPEED					10
#define PID_FLUX_KP_HIGHSPEED						100
#define PID_FLUX_KI_HIGHSPEED						10

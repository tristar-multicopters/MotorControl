...
/* Private defines -----------------------------------------------------------*/
#define M2_TEMPERATURE_Pin GPIO_PIN_0
#define M2_TEMPERATURE_GPIO_Port GPIOC
#define M2_CURR_ICS_V_Pin GPIO_PIN_1
#define M2_CURR_ICS_V_GPIO_Port GPIOC
#define M1_CURR_AMPL_V_Pin GPIO_PIN_0
#define M1_CURR_AMPL_V_GPIO_Port GPIOA
#define M1_CURR_ICS_U_Pin GPIO_PIN_1
#define M1_CURR_ICS_U_GPIO_Port GPIOA
...
#define M1_HALL_H1_Pin GPIO_PIN_5
#define M1_HALL_H1_GPIO_Port GPIOA
#define M1_CURR_ICS_V_Pin GPIO_PIN_7
#define M1_CURR_ICS_V_GPIO_Port GPIOA
#define M2_CURR_ICS_U_Pin GPIO_PIN_0
#define M2_CURR_ICS_U_GPIO_Port GPIOB
#define M2_CURR_AMPL_U_Pin GPIO_PIN_1
#define M2_CURR_AMPL_U_GPIO_Port GPIOB
...
#define M2_CURR_AMPL_V_GPIO_Port GPIOB
...
#define M2_HALL_H1_Pin GPIO_PIN_11
#define M2_HALL_H1_GPIO_Port GPIOA
#define M2_HALL_H2_Pin GPIO_PIN_12
#define M2_HALL_H2_GPIO_Port GPIOA

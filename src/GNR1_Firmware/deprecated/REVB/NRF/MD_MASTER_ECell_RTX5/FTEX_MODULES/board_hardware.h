...
#define M1SELECT_GPIO_PIN						NRF_GPIO_PIN_MAP(0,25) //25
#define M2SELECT_GPIO_PIN						NRF_GPIO_PIN_MAP(0,19) //19


/* Communication with host using UART -------------------------------------*/

#define HOST_UART_INSTANCE_ADDR			&uart0_inst
#define HOST_UART_TX_PIN						NRF_GPIO_PIN_MAP(0,23) //25
#define HOST_UART_RX_PIN						NRF_GPIO_PIN_MAP(0,22) //19

...
/*Vehicle and motor parameters. TO VERIFY...*/
VehiculeParameters_t VehiculeParam =
{ 0
};

MotorParameters_t M1_Params = 
{
	0
};

MotorParameters_t M2_Params = 
{
	0
};
/********************************************/
...
PAS_Handle_t PedalAssistHandler = {
 ...
 .pas_config = {
									...
									.pas_speed_encoder_pin = PAS_GPIO_PIN,
									.pas_type = PAS_TORQUE,
								},
};
...
VC_Handle_t VController = 
{
	...
	.pMotorParams = {&M1_Params, &M2_Params},
	.pMDComm = &MDComm,
	.pSTM = &VCStateMachine,
...
{ 
	.UARTconfig = 
	{
		.ufcp_handle = 
		{
			.p_uart_inst = HOST_UART_INSTANCE_ADDR,
		},
		.tx_pin = HOST_UART_TX_PIN,
		.rx_pin = HOST_UART_RX_PIN,
	},
	.pVController = &VController,
};

...
static void usb_new_event_isr_handler(app_usbd_internal_evt_t const * const p_event, bool queued)
{
    ...
    /* Notify Task host that a USBD event has been received */
		osThreadFlagsSet(TSK_ReplyToHost_handle, HOST_FLAG);
}

...
#define M1SELECT_GPIO_PIN						NRF_GPIO_PIN_MAP(0,15) //25 //We dont need these for the ebego
#define M2SELECT_GPIO_PIN						NRF_GPIO_PIN_MAP(0,14) //19


/* Communication over UART0 (for LCD display or other serial device) -------------------------------------*/

#define UART0_INSTANCE_ADDR			&uart0_inst
#define UART0_TX_PIN						NRF_GPIO_PIN_MAP(1,15) //25
#define UART0_RX_PIN						NRF_GPIO_PIN_MAP(1,14) //19

/* Pedal assist -------------------------------------*/

#define PAS_TIMER_INSTANCE_ADDR			&timer2_inst
#define PAS_GPIO_PIN								NRF_GPIO_PIN_MAP(0,19)

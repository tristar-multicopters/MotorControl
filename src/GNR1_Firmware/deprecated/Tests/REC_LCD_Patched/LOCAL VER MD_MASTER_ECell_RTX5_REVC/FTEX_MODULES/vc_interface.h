...
typedef struct {
	VehiculeParameters_t vc_params;
	MotorParameters_t md_params[NB_OF_MOTOR];
	int32_t th_params[TH_PARAMS_SIZE]; // for throttle params
	DRT_strg_values_t drt_values[NB_OF_MOTOR];

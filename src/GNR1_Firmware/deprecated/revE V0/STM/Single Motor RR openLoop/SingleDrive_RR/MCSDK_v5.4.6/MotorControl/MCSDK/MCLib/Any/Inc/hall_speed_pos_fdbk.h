...
typedef struct
{
  ...
  bool HallMtpa; /* if true at each sensor toggling, the true angle is set without ramp*/
	...
	uint32_t wCaptBuf_Prev;
	
	int32_t wCaptBuf_Delta;
	
	uint32_t Max_CaptureBuffer_Delta;
	...
	int16_t previous_AvrElSpeedDpp;
	
	int16_t AvrElSpeedDpp_medium;
	int16_t AvrMechSpeedUnit_medium;

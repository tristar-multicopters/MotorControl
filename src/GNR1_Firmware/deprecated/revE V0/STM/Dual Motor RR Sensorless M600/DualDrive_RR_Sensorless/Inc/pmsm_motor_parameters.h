...
#define NOMINAL_CURRENT         5000
#define MOTOR_MAX_SPEED_RPM     6000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  6.0 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -14894 /*!< Demagnetization current */
...
#define RS2                     0.15 /* Stator resistance , ohm*/
...
#define NOMINAL_CURRENT2         5000
#define MOTOR_MAX_SPEED_RPM2     6000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT2  6.0 /*!< Volts RMS ph-ph /kRPM */
...
#define HALL_PHASE_SHIFT2        240 /*!< Define here in degrees
                                                 the electrical phase shift between
                                                 the low to high transition of
                                                 signal H1 and the maximum of
                                                 the Bemf induced on phase A */

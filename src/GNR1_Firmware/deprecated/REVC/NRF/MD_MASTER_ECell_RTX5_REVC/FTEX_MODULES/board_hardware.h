...
#define MD_UART_RX_PIN						NRF_GPIO_PIN_MAP(0,4)


/* Communication with MCP2515 -------------------------------------*/

#define MCP_SS_PIN								NRF_GPIO_PIN_MAP(0,22)
#define MCP_INT_PIN								NRF_GPIO_PIN_MAP(0,29)
#define MCP_RST_PIN								NRF_GPIO_PIN_MAP(1,10)
#define MCP_SLCT_120R							NRF_GPIO_PIN_MAP(0,8)
	
/* SPI1 Bus -------------------------------------*/

#define SPI0_INSTANCE_ADDR					&spi0_inst
#define SPI0_MISO_PIN							NRF_GPIO_PIN_MAP(0,24)
...
#define M1SELECT_GPIO_PIN						NRF_GPIO_PIN_MAP(0,15)
#define M2SELECT_GPIO_PIN						NRF_GPIO_PIN_MAP(0,14)


/* Communication with host using UART -------------------------------------*/

#define HOST_UART_INSTANCE_ADDR			&uart0_inst
#define HOST_UART_TX_PIN						NRF_GPIO_PIN_MAP(0,25)
#define HOST_UART_RX_PIN						NRF_GPIO_PIN_MAP(0,19)

/* Pedal assist -------------------------------------*/

#define PAS_TIMER_INSTANCE_ADDR			&timer2_inst
#define PAS_GPIO_PIN								NRF_GPIO_PIN_MAP(0,27)

...
void StartVehicleTask(void const * argument);
...
int main(void)
{
  ...
  /* definition and creation of VehicleTask */
  osThreadDef(VehicleTask, StartVehicleTask, osPriorityLow, 0, 128);
  VehicleTaskHandle = osThreadCreate(osThread(VehicleTask), NULL);

...
#define PID_TORQUE_KP_DEFAULT         120
#define PID_TORQUE_KI_DEFAULT         12
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           120
#define PID_FLUX_KI_DEFAULT           12
...
#define HALL_MEAS_ERRORS_BEFORE_FAULTS2  6 /*!< Number of failed
                                                           ...
                                                           measurements before main sensor
                                                           goes in fault */
#define HALL_AVERAGING_FIFO_DEPTH2        10 /*!< depth of the FIFO used to
                                                           average mechanical speed in
                                                           0.1Hz resolution */
...
#define REGULATION_EXECUTION_RATE2     1    /*!< FOC execution rate in
                                                           number of PWM cycles */
/* Gains values for torque and flux control loops */
#define PID_TORQUE_KP_DEFAULT2         120
#define PID_TORQUE_KI_DEFAULT2         12
#define PID_TORQUE_KD_DEFAULT2         100
#define PID_FLUX_KP_DEFAULT2           120
#define PID_FLUX_KI_DEFAULT2           12
...
#define OV_VOLTAGE_THRESHOLD_V2          75 /*!< Over-voltage
                                                         threshold */
#define UD_VOLTAGE_THRESHOLD_V2          24 /*!< Under-voltage
                                                          threshold */
#if 0
...
#define REGULATION_EXECUTION_RATE2     1    /*!< FOC execution rate in
                                                           number of PWM cycles */
/* Gains values for torque and flux control loops */
#define PID_TORQUE_KP_DEFAULT2         500
#define PID_TORQUE_KI_DEFAULT2         50
#define PID_TORQUE_KD_DEFAULT2         100
#define PID_FLUX_KP_DEFAULT2           500
#define PID_FLUX_KI_DEFAULT2           50
#define PID_FLUX_KD_DEFAULT2           100
